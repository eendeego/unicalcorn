// This is the Adafruit Rotary Trinkey example for Volume Play/Pause Example
// changed to use Mute/Unmute instead of Play/Pause for parity with most
// volume knobs available online.
